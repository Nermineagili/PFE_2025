...
const SubscribeForm: React.FC<SubscribeFormProps> = ({ existingContract }) => {
  ...
  }, [showPolicySelection, formData.policyType]); // Re-run when policy selection changes
    ...
    <div className="subscribe-form-container">
      ...
      <form onSubmit={handleSubmit} className="subscribe-form">
        ...
        <div className="form-group">
          ...
          <div style={{ border: '1px solid #ccc', width: '300px', height: '150px', position: 'relative' }}>
            <canvas ref={canvasRef} width={300} height={150} style={{ border: '1px solid #ccc', position: 'absolute', top: 0, left: 0 }} />
          </div>
